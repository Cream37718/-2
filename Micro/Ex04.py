...
# หมุนมอเตอร์ซ้ายเป็นเวลา 1 นาที
ser.write(b'x')
print("Motor started after camera closed")
start_time = time.time()

# ส่งข้อความทางไลน์ว่าผ้ากำลังซักเมื่อมอเตอร์เริ่มหมุน
send_line_message("Cream", "ผ้าของคุณกำลังซัก")
print("Message sent: ผ้าของคุณกำลังซัก")
